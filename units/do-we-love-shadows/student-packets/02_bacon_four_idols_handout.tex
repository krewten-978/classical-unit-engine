...
{\large\scshape Francis Bacon and the Four Idols}\par\vspace{0.45em}
...
Plato gives us the image of prisoners mistaking shadows for reality. Bacon asks a related question: \textbf{what makes the mind produce, accept, and defend shadows in the first place?} He calls these false images \textit{idols}. Before people can reason well, Bacon says, they must learn to recognize the idols that already possess the mind.
...
\item Box one sentence that best connects Bacon back to Plato's cave.
\end{enumerate}
...
Answer in one clear paragraph: \textbf{How does Bacon help explain Plato's cave?} Your paragraph should state a claim, name at least one of Bacon's idols, explain how that idol could keep someone trapped in shadows, and connect your answer to education.

\section*{Handout Summary}
Finish by writing a short summary of this handout. In three to five sentences, explain Bacon's main warning about the human mind and name the four idols he says we must learn to recognize.
