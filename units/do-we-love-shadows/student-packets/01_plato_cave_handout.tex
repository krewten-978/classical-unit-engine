...
{\large\scshape Reading 1: Plato's Allegory of the Cave}\par\vspace{0.45em}
...
This passage is not mainly about learning facts. It is about what happens when a person is turned away from comfortable appearances and toward reality. Plato imagines education as painful, disorienting, and sometimes dangerous. As you read, ask: \textbf{Do human beings really want truth, or do we prefer comforting shadows?}
...
In 3--5 sentences, explain Plato's main image and what it suggests about truth. Include the cave, the painful turn toward the light, and the return to the prisoners. End with one sentence answering the unit question in Plato's terms.

\section*{Comparison Seed}
Keep this sentence for later readings: \textbf{For Plato, people resist truth because} \underline{\hspace{1.8in}}. As the unit continues, test whether Homer, Lucretius, Augustine, Bacon, Kant, and Nietzsche agree with Plato or give a different explanation.
